# Generated by Django 4.0.4 on 2022-05-28 03:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.PositiveSmallIntegerField(validators=[app.models.validators.validate_unit_year])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Available', 'Available'), ('Pending', 'Pending'), ('In progress', 'In progress'), ('Completed', 'Completed'), ('Invoiced', 'Invoiced')], max_length=11)),
                ...
                ('driver', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, to='app.driver', validators=[app.models.validators.driver_for_load_validator])),
        ...
        migrations.AddField(
            model_name='driver',
            name='coordinator',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='app.profile', validators=[app.models.validators.validate_coordinator]),
        ),
        migrations.AddField(
            model_name='driver',
            name='home_address',
